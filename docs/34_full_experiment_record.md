...
| F5b / F5b-fs / F5b-full | gemma_26b_local H6/H6fs/H6full, 40 val docs | In progress | Final full-field evaluation |
| F5c / F5c-fs / F5c-full | gemma_31b_local H6/H6fs/H6full, 40 val docs | In progress | Final full-field evaluation |
| H7 validation scale | GPT-4.1-mini H7 evidence-reconstructed, 40 val docs | Planned | H7 promotion decision |
| D3 validation scale | GPT-5.5 D3 with evidence, 40 val docs | Planned | D3 promotion decision |
...
| F5b | gemma4:26b | H6 | Expanded gemma scale 26B | needs run |
| F5b-fs | gemma4:26b | H6fs | Gemma4 26B few-shot | needs run |
| F5b-full | gemma4:26b | H6full | Gemma4 26B full-field harness | needs run |
| F5c | gemma4:31b | H6 | Expanded gemma scale 31B | needs run |
| F5c-fs | gemma4:31b | H6fs | Gemma4 31B few-shot | needs run |
| F5c-full | gemma4:31b | H6full | Gemma4 31B full-field harness | needs run |
...
| gpt_5_5 | OpenAI GPT-5.5 | Stage A/B/D/E, Gan G2/G3/G4 | Yes |
| gpt_5_4_mini | OpenAI GPT-5.4-mini | Stage A/B/C1/D/E | Yes |
...
| qwen3.6:35b (qwen_35b_local) | Ollama local | Large model validation, F3, G2/G3/G4, EL1/EL2 | Yes |
| gemma4:26b (gemma_26b_local) | Ollama local | F5b (H6full in progress) | In progress |
| gemma4:31b (gemma_31b_local) | Ollama local | F5c (H6full in progress) | In progress |
